LootJS.modifiers((event) => {
  ...
  // camel
  event.addEntityLootModifier("minecraft:camel")
  ...
  // dolphin
  event.addEntityLootModifier("minecraft:dolphin")
  ...
  // frog
  event.addEntityLootModifier("minecraft:frog")
  ...
  // turtle
  event.addEntityLootModifier("minecraft:turtle")
